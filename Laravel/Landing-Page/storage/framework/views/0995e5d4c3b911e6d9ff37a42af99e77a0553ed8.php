    ...
    <div class="my-3">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group d-flex" style="color: black;">
                ...
                : <div style="word-break: break-all; text-align:justify; width:600px;"><?php echo $story->story; ?></div>
            </div>
        </div>
...
<?php echo $__env->make('..dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abdmalik/Laravel/landing_page/resources/views/stories/show.blade.php ENDPATH**/ ?>