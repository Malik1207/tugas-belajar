        ...
        <div class="my-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control my-1" style="height:150px" name="review" placeholder="review"><?php echo e($testimonial->review); ?></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
...
<?php echo $__env->make('testimonials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abdmalik/laravel/landing_page/resources/views/testimonials/edit.blade.php ENDPATH**/ ?>