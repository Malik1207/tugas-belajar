				...
				<div class="section__content px-1">
					 <div class="container-fluid">
						  <div class="header-wrap d-flex">
								<h3 class="text-secondary">LIST ASET</h3>
				...
				<div class="section__content section__content--p20">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								 <!-- DATA TABLE -->
								 <!-- <h3 class="title-5 m-b-35">List Aset</h3> -->
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="scrollmodalLabel">Tambah Data Aset</h5>
								 ...
								 <div class="card">
									  <div class="card-body card-block">
											<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
												 ...
												 <div class="row form-group">
													<div class="col col-md-3">
														 <label for="text-input" class=" form-control-label">Nama Aset</label>
													</div>
													<div class="col-12 col-md-9">
												 ...
												 <div class="row form-group">
													  <div class="col col-md-3">
															<label for="selectSm" class=" form-control-label">Kategori Aset</label>
													  </div>
													  <div class="col-12 col-md-9">
...
<!-- end document-->
<?php /**PATH /home/abdmalik/sim-aset/resources/views/master-data/list-aset.blade.php ENDPATH**/ ?>