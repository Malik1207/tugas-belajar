                ...
                <div class="section__content px-1">
                    <div class="container-fluid">
                        <div class="header-wrap d-flex">
                            ...
                            <h3 class="text-secondary">MONITORING</h3>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="scrollmodalLabel">Tambah Data Monitoring</h5>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="selectSm" class=" form-control-label">Kode Aset</label>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea type="text" id="text-input" name="text-input" placeholder="" class="form-control"></textarea>
                                                <!-- <small class="form-text text-muted">This is a help text</small> -->
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Faktor</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <textarea type="text" id="text-input" name="text-input" placeholder="" class="form-control"></textarea>
                                                <!-- <small class="form-text text-muted">This is a help text</small> -->
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Monitoring</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <textarea type="text" id="text-input" name="text-input" placeholder="" class="form-control"></textarea>
                                                <!-- <small class="form-text text-muted">This is a help text</small> -->
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Pemeliharaan</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <textarea type="text" id="text-input" name="text-input" placeholder="" class="form-control"></textarea>
                                                <!-- <small class="form-text text-muted">This is a help text</small> -->
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Gambar Aset</label>
                                            </div>
                                            <div class="col-12 col-md-9">
...
<!-- end document-->
<?php /**PATH /home/abdmalik/sim-aset/resources/views/monitoring.blade.php ENDPATH**/ ?>