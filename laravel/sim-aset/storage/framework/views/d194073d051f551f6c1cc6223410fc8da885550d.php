                ...
                <div class="section__content px-1">
                    <div class="container-fluid">
                        <div class="header-wrap d-flex">
                            ...
                            <h3 class="text-secondary">FORM PENGHAPUSAN ASET</h3>
                                ...
                                <div class="card">
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="selectSm" id="SelectLm" class="form-control form-control">
                                                        ...
                                                        <option value="1">039250580</option>
                                                        <option value="2">039250580</option>
                                                        <option value="3">039250580</option>
                                                        <option value="4">039250580</option>
                                                        <option value="5">039250580</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Jumlah yang dihapuskan</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Faktor penyebab</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="text-input" name="text-input" placeholder="" class="form-control">
                                                    <!-- <small class="form-text text-muted">This is a help text</small> -->
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Tanggal Penghapusan</label>
                                                </div>
                                                <div class="col-5">
...
<!-- end document-->
<?php /**PATH /home/abdmalik/sim-aset/resources/views/penghapusan.blade.php ENDPATH**/ ?>