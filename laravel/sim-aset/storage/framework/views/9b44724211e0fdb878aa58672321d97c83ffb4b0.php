                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo e(asset('images/icon/avatar-01.jpg')); ?>" alt="John Doe" />
                                        </div>
                                        <div class="content">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-25">
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <span class="text-white">Total Aset</span>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <span class="text-white">Kategori Aset</span>
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <span class="text-white">Aset yang dihapus</span>
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <span class="text-white">Total Ruangan</span>
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="title-1 m-b-25">Aktivitas Terkini</h2>
                                <div class="table-responsive table--no-card m-b-40 f">
                                    <table class="table table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Kode Aset</th>
                                                <th>Nama Aset</th>
                                                <th class="text-right">Kategori Aset</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>100398</td>
                                                <td>Kipas Angin</td>
                                                <td class="text-right">Elektronik</td>
                                                <td class="text-right">Dihapus</td>
                                                <td class="text-right">2</td>
                                                <td class="text-right">Perpustakaan</td>
                                                <td class="text-right">
                                                    <a href="#">Details</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>100398</td>
                                                <td>Meja</td>
                                                <td class="text-right">Furniture</td>
                                                <td class="text-right">Diperbaiki</td>
                                                <td class="text-right">2</td>
                                                <td class="text-right">Ruang B309</td>
                                                <td class="text-right">
                                                    <a href="#">Details</a>
                                                </td>
                                            </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">Kondisi Aset</h3>
                                        <div class="row">
                                            <div class="col mt-5">
                                                <div class="d-flex justify-content-between">
                                                    <div class="d-flex">
                                                        <i class="bi bi-circle-fill text-primary mr-4"></i>                                                        
                                                        <span>Baik</span>
                                                    </div>
                                                    <div class="d-flex">
                                                        <i class="bi bi-circle-fill text-warning mr-4"></i>                                                        
                                                        <span>Renovasi</span>
                                                    </div>
                                                    <div class="d-flex">
                                                        <i class="bi bi-circle-fill text-danger mr-4"></i>                                                        
                                                        <span>Rusak</span>
                                                    </div>
                                                </div>
...
<!-- end document-->
<?php /**PATH /home/abdmalik/sim-aset/resources/views/welcome.blade.php ENDPATH**/ ?>