                ...
                <div class="section__content px-1">
                    <div class="container-fluid">
                        <div class="header-wrap d-flex">
                            ...
                            <h3 class="text-secondary">LAPORAN DATA PENGADAAN</h3>
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">Lokasi Aset</option>
                                                <option value="">Ruang I</option>
                                                <option value="">Ruang I</option>
                                                <option value="">Ruang I</option>
                                                <option value="">Ruang I</option>
                                            </select>
                                    ...
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--small bg-danger">
                                            <a href="#" class="text-decoration-none text-light"><i class="bi bi-printer-fill"></i>Print</a>
                                        </button>
                                        <button class="au-btn au-btn-icon au-btn--small bg-success">
                                            <a href="#" class="text-decoration-none text-light"><i class="bi bi-newspaper"></i>Export Excel</a>
                                        </button>
...
<!-- end document-->
<?php /**PATH /home/abdmalik/sim-aset/resources/views/laporan/laporan-pengadaan.blade.php ENDPATH**/ ?>