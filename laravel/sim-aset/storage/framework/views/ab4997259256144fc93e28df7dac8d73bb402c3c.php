    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <header class="header-desktop">
                <div class="section__content px-1">
                    <div class="container-fluid">
                        <div class="header-wrap d-flex">
                            ...
                            <h3 class="text-secondary">ASET BERWUJUD</h3>
                ...
                <div class="section__content section__content--p25">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <!-- <h3 class="title-5 m-b-35">Aset berwujud</h3> -->
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <form class="form-header" action="" method="POST">
                                            <input class="au-input au-input--xl" type="text" name="search" placeholder="Search for items..." />
                                            <button class="au-btn--submit" type="submit">
                                                <i class="zmdi zmdi-search"></i>
                                            </button>
                                        </form>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="scrollmodalLabel">Tambah Aset berwujud</h5>
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">Kode Aset</label>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="number" id="text-input" name="text-input" placeholder="" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">Nilai Aset</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="number" id="text-input" name="text-input" placeholder="" class="form-control">
                                                    </div>
                                                ...
                                                <!-- <div class="row form-group">
                                                    <div class="col col-md-3">
                                                            <label for="selectSm" class=" form-control-label">Nama Kategori</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                            <label for="text-input" class=" form-control-label">Terakhir Update</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                            <input type="text" id="text-input" name="text-input" placeholder="" class="form-control">
                                                    </div>
                                                ...
                                                <!-- <div class="row form-group">
                                                    <div class="col col-md-3">
                                                            <label for="text-input" class=" form-control-label">Tahun Perolehan</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                            <input type="number" id="text-input" name="text-input" placeholder="" class="form-control">
                                                    </div>
...
<!-- end document-->
<?php /**PATH /home/abdmalik/sim-aset/resources/views/data-aset/aset-berwujud.blade.php ENDPATH**/ ?>