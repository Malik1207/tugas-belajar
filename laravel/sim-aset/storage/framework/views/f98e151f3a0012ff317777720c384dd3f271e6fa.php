                ...
                <div class="section__content px-1">
                    <div class="container-fluid">
                        <div class="header-wrap d-flex">
                            ...
                            <h3 class="text-secondary">LOKASI ASET</h3>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="scrollmodalLabel">Tambah Lokasi</h5>
...
<!-- end document-->
<?php /**PATH /home/abdmalik/sim-aset/resources/views/master-data/lokasi-aset.blade.php ENDPATH**/ ?>