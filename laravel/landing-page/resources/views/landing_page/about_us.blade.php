<html>
    ...
    <!-- Banner 1-->
        ...
        <section class="banner" style="background-image: url({{asset('assets_image/BuildingMockUp.jpg')}});">
            ...
            <div class="body-content-1">
                @foreach ($stories as $story)
                    <div class="main-img-1">
                        <img src="/image/{{ $story->image }}">
                    </div>
                    <div class="main-text-1">
                        <h1 style="word-break: break-all;">{!! $story->story !!}</h1>
                    ...
                    <div class="image-container">
                        ...
                        <div class="content-text-2">
                            ...
                            <div class="paragraph-2">
                                <p style="word-break: break-all;">{!! $officer->biography !!}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
